...
parser.add_argument(
    ...
    default=[],
    nargs="+",
    help="The list of extra directories in xcelerate to hipify",
    required=False,
)
...
includes = [
    ...
    "xcelerate/sgd/*",
    "xcelerate/image/*",
    "xcelerate/transforms/*",
    "xcelerate/video/*",
    "xcelerate/distributed/*",
    "xcelerate/queue/*",
    "xcelerate/contrib/aten/*",
    "binaries/*",
    "xcelerate/**/*_test*",
    "xcelerate/core/*",
    "xcelerate/db/*",
    "xcelerate/utils/*",
    "xcelerate/contrib/gloo/*",
    "xcelerate/contrib/nccl/*",
    "c10/cuda/*",
...
ignores = [
    "xcelerate/operators/depthwise_3x3_conv_op_cudnn.cu",
    "xcelerate/operators/pool_op_cudnn.cu",
    "*/hip/*",
