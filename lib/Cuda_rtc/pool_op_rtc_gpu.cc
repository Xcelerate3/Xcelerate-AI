...
#include "Xcelerate/operators/pool_op.h"
 ...
 public:
  ...
  bool RunOnDeviceWithOrderNCHW() override {
    ...
    if (input_dims_ != X.sizes()) {
      ...
      XCELERATE_ENFORCE_LT(Y->numel(), std::numeric_limits<int>::max());
      func_.Compile(
