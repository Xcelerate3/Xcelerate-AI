#ifndef xcelerate_CORE_BLOB_SERIALIZATION_H_
#define xcelerate_CORE_BLOB_SERIALIZATION_H_
...
#include "xcelerate/core/blob_serializer_base.h"
#include "xcelerate/core/tensor.h"

#include <c10/util/irange.h>
#include <c10/util/typeid.h>
#include "xcelerate/core/types.h"
#include "xcelerate/utils/simple_queue.h"

C10_DECLARE_int(xcelerate_tensor_chunk_size);
C10_DECLARE_int(xcelerate_max_tensor_serializer_threads);
C10_DECLARE_bool(xcelerate_serialize_fp16_as_bytes);
...
#endif  // xcelerate_CORE_BLOB_SERIALIZATION_H_
