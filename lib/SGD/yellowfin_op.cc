#include "xcelerate/sgd/yellowfin_op.h"
...
#define xcelerate_YELLOWFIN_GETLRMU(T)                                         \
  template <>                                                               \
...
xcelerate_YELLOWFIN_GETLRMU(float)
#undef xcelerate_YELLOWFIN_GETLRMU

// Usually moment_ == moment_out_ && param_ == param_out_
#define xcelerate_YELLOWFIN_MOMENTUMSGDUPDATE(T)                                  \
  template <>                                                                  \
...
xcelerate_YELLOWFIN_MOMENTUMSGDUPDATE(float)
#undef xcelerate_YELLOWFIN_MOMENTUMSGDUPDATE
