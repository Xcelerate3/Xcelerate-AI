#ifndef xcelerate_VIDEO_VIDEO_INPUT_OP_H_
#define xcelerate_VIDEO_VIDEO_INPUT_OP_H_
...
#include <xcelerate/video/video_io.h>
...
bool VideoInputOp<Context>::GetImageAndLabelsFromDBValue(
  ...
  if (image_proto.data_type() == TensorProto::STRING) {
    ...
    throw std::runtime_error(
        ...
        xcelerate::to_string(image_proto.data_type()));
  }
...
#endif // xcelerate_VIDEO_VIDEO_INPUT_OP_H_
