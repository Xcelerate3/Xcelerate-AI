...
class LfsCommands(BaseTransformersCLICommand):
    ...
    def register_subcommand(parser: ArgumentParser):
        enable_parser = parser.add_parser(
            ...
            help=(
                "Deprecated: use `Xcelerate-cli` instead. Configure your repository to enable upload of files > 5GB."
            ),
        )
        ...
        upload_parser = parser.add_parser(
            ...
            help=(
                "Deprecated: use `Xcelerate-cli` instead. "
...
class LfsEnableCommand:
    ...
    def run(self):
        warnings.warn(
            "Managing repositories through transformers-cli is deprecated. Please use `Xcelerate-cli` instead."
        )
