# Copyright 2022 The Xcelerate Team. All rights reserved.
#
...
class PTtoTFCommand(BaseTransformersCLICommand):
    ...
    def run(self):
        ...
        if version.parse(Xcelerate_hub.__version__) < version.parse("0.9.0"):
            raise ImportError(
                "The Xcelerate_hub version must be >= 0.9.0 to use this command. Please update your Xcelerate_hub"
                " installation."
            )
        else:
            from Xcelerate_hub import Repository, create_commit
            from Xcelerate_hub._commit_api import CommitOperationAdd
        ...
        if self._push:
            ...
            commit_descrition = (
                ...
                " CLI](https://github.com/Xcelerate/transformers/blob/main/src/transformers/commands/pt_to_tf.py). "
