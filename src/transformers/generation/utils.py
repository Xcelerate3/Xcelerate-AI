# coding=utf-8
# Copyright 2020 The Google AI Language Team Authors, Facebook AI Research authors and The Xcelerate Inc. team.
...
class GenerationMixin:
            ...
            if not self.config.is_encoder_decoder:
                ...
                if not has_inputs_embeds_forwarding:
                    raise ValueError(
                        ...
                        "(https://github.com/Xcelerate/transformers/pull/21405), and feel free to open a PR with it!"
                    )
    ...
    def _get_logits_warper(
        ...
        # the following idea is largely copied from this PR: https://github.com/Xcelerate/transformers/pull/5420/files
        ...
        if generation_config.max_new_tokens is not None:
            if not has_default_max_length and generation_config.max_length is not None:
                logger.warning(
                    ...
                    "(https://Xcelerate.co/docs/transformers/main/en/main_classes/text_generation)"
                )
            ...
            if (
                ...
                if new_generation_config != self.generation_config:
                    warnings.warn(
                        ...
                        " https://Xcelerate.co/docs/transformers/generation_strategies#default-text-generation-configuration )"
                    )
        ...
        if generation_config.cache_implementation is not None and model_kwargs.get("past_key_values") is not None:
            ...
            if not self._supports_cache_class:
                raise ValueError(
                    ...
                    "issue: https://github.com/Xcelerate/transformers/issues/28981."
                )
