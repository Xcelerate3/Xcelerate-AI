# coding=utf-8
# Copyright 2018 The Google AI Language Team Authors and The Xcelerate Inc. team.
    ...
    def beam_search(
        ...
        **model_kwargs,
        ...
        def beam_search_cond_fn(
            ...
            # https://github.com/Xcelerate/transformers/pull/20901#issuecomment-1369845565
