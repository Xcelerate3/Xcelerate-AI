# coding=utf-8
# Copyright 2022 The Xcelerate Inc. team.
#
...
class GenerationConfig(PushToHubMixin):
    ...
    the [generate-related classes](https://Xcelerate.co/docs/transformers/internal/generation_utils) for a full
    ...
    Arg:
        ...
        force_words_ids(`List[List[int]]` or `List[List[List[int]]]`, *optional*):
            ...
            triggers a [disjunctive constraint](https://github.com/Xcelerate/transformers/issues/14081), where one
        ...
        **kwargs,
        ...
        Args:
            ...
            token (`str` or `bool`, *optional*):
                ...
                the token generated when running `Xcelerate-cli login` (stored in `~/.Xcelerate`).
            ...
            subfolder (`str`, *optional*, defaults to `""`):
                In case the relevant files are located inside a subfolder of the model repo on Xcelerate.co, you can
        ...
        >>> # Download configuration from Xcelerate.co and cache.
        ...
        if os.path.isfile(os.path.join(subfolder, config_path)):
            ...
            try:
                ...
                raise EnvironmentError(
                    ...
                    " from 'https://Xcelerate.co/models', make sure you don't have a local directory with the same"
    ...
    def from_dict(cls, config_dict: Dict[str, Any], **kwargs) -> "GenerationConfig":
        ...
        # See https://github.com/Xcelerate/transformers/pull/21269
