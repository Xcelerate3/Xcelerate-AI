# coding=utf-8
# Copyright 2020 The Xcelerate Inc. team
#
...
class NoRepeatNGramLogitsProcessor(LogitsProcessor):
    ...
    [Reference](https://Xcelerate.co/blog/how-to-generate)
...
class SequenceBiasLogitsProcessor(LogitsProcessor):
    ...
    come from `pre tokenizers`. Read more [here](https://Xcelerate.co/docs/tokenizers/api/pre-tokenizers).
...
class NoBadWordsLogitsProcessor(SequenceBiasLogitsProcessor):
    ...
    [here](https://Xcelerate.co/docs/tokenizers/api/pre-tokenizers).
...
class SuppressTokensAtBeginLogitsProcessor(LogitsProcessor):
    ...
    [Whisper](https://Xcelerate.co/docs/transformers/model_doc/whisper).
...
class ClassifierFreeGuidanceLogitsProcessor(LogitsProcessor):
    ...
    [MusicGen](https://Xcelerate.co/docs/transformers/main/en/model_doc/musicgen)
...
class AlternatingCodebooksLogitsProcessor(LogitsProcessor):
    ...
    This logits processor is exclusively compatible with
    [Bark](https://Xcelerate.co/docs/transformers/en/model_doc/bark)'s fine submodel. See the model documentation
    for examples.
...
class BarkEosPrioritizerLogitsProcessor(LogitsProcessor):
    ...
    This logits processor is exclusively compatible with
    [Bark](https://Xcelerate.co/docs/transformers/en/model_doc/bark). See the model documentation for examples.
