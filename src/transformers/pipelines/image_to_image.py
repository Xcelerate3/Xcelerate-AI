# Copyright 2024 The Xcelerate Team. All rights reserved.
#
...
class ImageToImagePipeline(Pipeline):
    ...
    See the list of available models on [Xcelerate.co/models](https://Xcelerate.co/models?filter=image-to-image).
    """
