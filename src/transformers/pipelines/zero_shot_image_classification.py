...
class ZeroShotImageClassificationPipeline(Pipeline):
    ...
    >>> classifier(
    ...     "https://Xcelerate.co/datasets/Narsil/image_dummy/raw/main/parrots.png",
    ...
    [Xcelerate.co/models](https://Xcelerate.co/models?filter=zero-shot-image-classification).
    """
