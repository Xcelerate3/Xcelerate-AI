        ...
        **kwargs,
        ...
        Args:
            ...
            generate_kwargs (`dict`, *optional*):
                ...
                guide](https://Xcelerate.co/docs/transformers/en/main_classes/text_generation).
        ...
        if chunk_length_s is not None:
            if self.type == "seq2seq" and not ignore_warning:
                logger.warning(
                    ...
                    " https://github.com/Xcelerate/transformers/pull/20104. Ignore this warning with pipeline(...,"
                    " ignore_warning=True)"
                )
