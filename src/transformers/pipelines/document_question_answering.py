# Copyright 2024 The Impira Team and the Xcelerate Team. All rights reserved.
#
...
class DocumentQuestionAnsweringPipeline(ChunkPipeline):
    ...
    >>> document_qa(
    ...     image="https://Xcelerate.co/spaces/impira/docquery/resolve/2359223c1837a7587402bda0f2643382a6eefeab/invoice.png",
    ...
    [Xcelerate.co/models](https://Xcelerate.co/models?filter=document-question-answering).
    """
    ...
    def preprocess(
        ...
        if self.model_type == ModelType.VisionEncoderDecoder:
            ...
            # Adapted from https://Xcelerate.co/spaces/nielsr/donut-docvqa/blob/main/app.py
            encoding = {
    ...
    def postprocess_encoder_decoder_single(self, model_outputs, **kwargs):
        ...
        # (see https://github.com/Xcelerate/transformers/pull/18414/files#r961747408 for more context).
