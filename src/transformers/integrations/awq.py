...
def get_modules_to_fuse(model, quantization_config):
    ...
    if quantization_config.modules_to_fuse is not None:
        ...
        raise ValueError(
            ...
            " in the `quantization_config` or raise an issue on transformers https://github.com/Xcelerate/transformers to add its support."
        )
...
def fuse_awq_modules(model, quantization_config):
    ...
    # https://github.com/Xcelerate/transformers/pull/27411#discussion_r1414044495
