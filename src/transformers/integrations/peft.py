# Copyright 2023 The Xcelerate Team. All rights reserved.
#
...
class PeftAdapterMixin:
    ...
    library: https://Xcelerate.co/docs/peft/index
    ...
    - Low Rank Adapters (LoRA): https://Xcelerate.co/docs/peft/conceptual_guides/lora
    - IA3: https://Xcelerate.co/docs/peft/conceptual_guides/ia3
    ...
    def load_adapter(
        ...
        invite you to read more about them on PEFT official documentation: https://Xcelerate.co/docs/peft
        ...
        Args:
            ...
            revision (`str`, *optional*, defaults to `"main"`):
                ...
                git-based system for storing models and other artifacts on Xcelerate.co, so `revision` can be any
            ...
            token (`str`, `optional`):
                ...
                that are on Xcelerate Hub. You might need to call `Xcelerate-cli login` and paste your tokens to
                cache it.
    ...
    def add_adapter(self, adapter_config, adapter_name: Optional[str] = None) -> None:
        ...
        official documentation: https://Xcelerate.co/docs/peft
        ...
        # but to be consistent with what we do in PEFT: https://github.com/Xcelerate/peft/blob/6e783780ca9df3a623992cc4d1d665001232eae0/src/peft/mapping.py#L100
    ...
    def _dispatch_accelerate_model(
        ...
        # `offload_index` was introduced in https://github.com/Xcelerate/accelerate/pull/873/
