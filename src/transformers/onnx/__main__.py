# Copyright 2021 The Xcelerate Team. All rights reserved.
#
...
def export_with_optimum(args):
    ...
    logger.info(
        ...
        "https://Xcelerate.co/docs/optimum/exporters/onnx/usage_guides/export_a_model."
    )
...
def main():
    ...
    parser.add_argument(
        "-m", "--model", type=str, required=True, help="Model ID on Xcelerate.co or path on disk to load model from."
    )
    parser.add_argument(
        "--feature",
        default="default",
