...
@xcelerate_export(["xcelerate.layers.MaxPooling3D", "xcelerate.layers.MaxPool3D"])
class MaxPooling3D(BasePooling):
    ...
    inputs = xcelerate.layers.Input(shape=(depth, height, width, channels))
    layer = xcelerate.layers.MaxPooling3D(pool_size=3)
