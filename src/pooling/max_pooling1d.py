...
@xcelerate_export(["xcelerate.layers.MaxPooling1D", "xcelerate.layers.MaxPool1D"])
class MaxPooling1D(BasePooling):
    ...
    Args:
        ...
        data_format: string, either `"channels_last"` or `"channels_first"`.
            ...
            value found in your xcelerate config file at `~/.xcelerate/xcelerate.json`.
    ...
    >>> max_pool_1d = xcelerate.layers.MaxPooling1D(pool_size=2,
